...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4>Alteração de Categoria</h4>
	</div>
	<div class="panel-body">
		<form class="form-horizontal" action="/categoria/update" method="POST">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-6 col-sm-8">
				<input id="descricao" name="descricao" type="text" value="{{ $categoria->descricao }}" placeholder="Digite a descrição da categoria" class="form-control input-md">
