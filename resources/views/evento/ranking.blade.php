			...
			<div class="col mb-1">
					<div class="card">
						<div class="card-header">
							<a class="btn btn-link" data-toggle="collapse" href="#melhores_feira" role="button" aria-expanded="false" aria-controls="collapseExample">
								Ranking Geral
							</a>
						</div>
						<div class="card-body collapse table-responsive" id="melhores_feira">
							<table id="table-melhores_feira" class="table table-condensed table-hover table-striped">
								<thead>
									<tr>
										<th>Cod</th>
										<th>Título</th>
								...
								<tbody>
									@forelse($evento->melhores_feira as $t)
									<tr>
										<td>{{ $t->cod }}</td>
										<td>{{ $t->titulo }}</td>
					...
					<div class="card">
						...
						<div class="card-body collapse table-responsive" id="{{$c}}-card-{{$loop->index}}">
							<table id="table-{{$c}}" class="table table-condensed table-hover table-striped">
								...
								<tbody>
									@forelse($categoria->melhores_categoria as $t)
									<tr>
										<td>{{ $t->cod }}</td>
										<td>{{ $t->titulo }}</td>
										<td>{{ $t->tipoTrabalho->nome }}</td>
